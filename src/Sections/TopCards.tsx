...
const TopCards: React.FC = () => {
  return (
    <section className="w-full h-[1600px] [@media(max-width:899px)]:h-[1400px] bg-[#FCFAF4] relative overflow-x-hidden [@media(max-width:899px)]:overflow-x-hidden transform animate-topcards-tilt">
